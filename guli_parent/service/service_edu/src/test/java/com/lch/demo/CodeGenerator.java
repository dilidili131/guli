...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setServiceName("%Service");//去掉生成Service接口的首字母
        // Todo 改主键生成策略
        ...
        //        return "D:\\code\\guli_parent\\service\\service_edu" + "/src/main/resources/mapper/" + pc.getModuleName()
        ...
        strategy.setEntityLombokModel(true);//lomnok模型 @Accessors(chain = true) setter链式操作
        strategy.setRestControllerStyle(true);//restful api风格控制器
        strategy.setControllerMappingHyphenStyle(true);//url中驼峰连连字符
